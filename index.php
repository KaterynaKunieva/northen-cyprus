...
<main>
  <div class="main_head" style="background-image: url(img/main_bg_2.jpg);">
    <div class="container">
  ...
  <div class="about">
    ...
    <div class="about__list">
      <div class="about__list_item animation_5">
        ...
        <div class="about__list-title">Надёжность</div>
        <div class="about__list-text">
          Мы работаем только с проверенными качественными застройщиками
          и их проектами
        </div>
      </div>
      <div class="about__list_item animation_5">
        ...
        <div class="about__list-title">сервис</div>
        <div class="about__list-text">
          Помогаем решить любые задачи на всех этапах, относясь к своим
      ...
      <div class="about__list_item animation_5">
        ...
        <div class="about__list-title">Профессионализм</div>
        <div class="about__list-text">
          Разбираемся в качестве строительных материалов и процессе
          строительства
        </div>
      </div>
      <div class="about__list_item animation_5">
        ...
        <div class="about__list-title">забота</div>
        <div class="about__list-text">
          Выявляем и удовлетворяет Вашу индивидуальную потребность,
          учитывая любые пожелания и идеи
        </div>
      </div>
    </div>
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="advantages__list">
        <div class="advantages__list_item animation_5">
          ...
          <div class="advantages__list-text">
        ...
        <div class="advantages__list_item animation_5">
          ...
          <div class="advantages__list-text">
            Безвизовый режим и возможность получения ВНЖ
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="search">
      ...
      <form action="#" class="search__form animation_1">
        <div class="select">
          <select name="type" class="select_type">
            ...
            <option value="default">Апартаменты</option>
            <option value="default">Виллы</option>
            <option value="default">Бунгало</option>
            <option value="default">Земельные участки</option>
          </select>
          <i class="icon"></i>
        </div>
    ...
    <a href="estate.php"><input type="button" class="btn more__btn" value="смотреть больше " /></a>
  </div>
</main>
