  ...
  var e = Array.prototype.slice,
    ...
    a = function () {
      for (
        ...
        var l = o[p],
          u = l.stickyWrapper.offset().top - l.topSpacing - a;
        if (
          (l.stickyWrapper.css("height", l.stickyElement.outerHeight()), e <= u)
        )
          null !== l.currentTop &&
            (l.stickyElement.css({
              width: "",
          ...
          var h =
            ...
            a;
          if (
            (h < 0 ? (h += l.topSpacing) : (h = l.topSpacing),
            l.currentTop !== h)
          ) {
            var g;
            l.getWidthFrom
              ? (g = t(l.getWidthFrom).width() || null)
              : l.widthFromWrapper && (g = l.stickyWrapper.width()),
              null == g && (g = l.stickyElement.width()),
              l.stickyElement
                .css("width", g)
                .css("position", "fixed")
                .css("top", h)
              ...
              (l.currentTop === l.topSpacing && l.currentTop > h) ||
              (null === l.currentTop && h < l.topSpacing)
