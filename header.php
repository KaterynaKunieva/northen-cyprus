...
<head>
  ...
  header {
    ...
    align-items: center;
    position: absolute;
    padding: 10px 58px 0 92px;
    width: 100%;
    background: -webkit-gradient(linear, left top, left bottom, from(#006264), to(transparent));
    background: -o-linear-gradient(top, #006264, transparent);
    background: linear-gradient(180deg, #006264, transparent)
  }

  .header__about {
    padding: 10px 58px 145px 92px
  }
  ...
  .header__contacts .head__menu ul li a:hover {
    color: #a1827c
  }
  ...
  .header__logo {
    ...
    width: 100%;
    height: 100%;
    background: -o-radial-gradient(center, ellipse, rgba(255, 255, 255, .2) 30%, rgba(255, 255, 255, 0) 70%);
  ...
  .sandwich__menu.active .sw-topper {
    position: absolute;
    top: 5px;
  ...
  .sandwich__menu.active .sw-footer {
    position: absolute;
    top: 5px;
    left: 0;
    -webkit-transform: rotate(45deg);
  ...
  .sandwich__menu.active .sw-bottom {
    opacity: 0;
